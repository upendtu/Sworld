...
$ch=curl_init("http://www.michaelpage.co.jp/en/browse/jobs/healthcare-and-life-sciences/all/all?languages[0]=en");
...
/*$cname = mysql_real_escape_string($name->plaintext);
 ...
 $debugquery = mysql_query("INSERT INTO companyinfo (title,url,location,info,country,language,work) VALUES ('$title','$url','$location','$info','Japan','English',' Health') ");
