...
$country = $_POST['country'];
 ...
 $sql = "SELECT * FROM companyinfo  WHERE Language LIKE '" . mysql_real_escape_string($language) . "%' AND work LIKE '%" . mysql_real_escape_string($work) . "%' AND country LIKE '%" . mysql_real_escape_string($country) . "%'" ;
