<script type='text/javascript' src='popup contact/scripts/gen_validatorv31.js'></script>
<script type='text/javascript' src='popup contact/scripts/fg_ajax.js'></script>
<script type='text/javascript' src='popup contact/scripts/fg_moveable_popup.js'></script>
<script type='text/javascript' src='popup contact/scripts/fg_form_submitter.js'></script>
<div id='fg_formContainer'>
    <div id="fg_container_header">
        <div id="fg_box_Title">Send Email</div>
	...
	<div class='container'>
        <label for='name' >Your Company Url*: </label><br/>
        <input type='text' name='url' id='name' value='' maxlength="50" /><br/>
        <span id='contactus_name_errorloc' class='error'></span>
    </div>
    <div class='container'>
    <label for='email' >Candidate Email Address*:</label><br/>
    ...
    <div class='container'>
        <label for='message' >About Company:</label><br/>
...
// <![CDATA[
    ...
    frmvalidator.addValidation("name","req","Please provide your company name");
	frmvalidator.addValidation("name","req","Please provide your company url");
    ...
    function fg_submit_form()
    {
        ...
        var submitter = new FG_FormSubmitter("popup contact/popup-contactform.php",containerobj,sourceobj,error_div,formobj);
...
<div id='fg_submit_success_message'>
    ...
    <p>
    Thanks for contacting to the Right candidate. Candidate will get in touch with you soon!
    <p>
