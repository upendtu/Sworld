...
function googleTranslateElementInit() {
  new google.translate.TranslateElement({pageLanguage: 'en', includedLanguages: 'de,en,es,fr,it,ja,ko,ru,zh-CN,zh-TW', layout: google.translate.TranslateElement.InlineLayout.SIMPLE}, 'google_translate_element');
		...
		<div class="slideshow">
	      <ul class="slideshow">
            <li class="show"><img width="1300" height="500" src="image/1.jpg" alt="Talents are common, everyone has them - but rare is the courage to follow our talents where they lead." /></li>
...
<option value="france">France</option>
	...
	<input type="submit" name="submit" class="submit" value="search"/>
	   ...
	   <h3 align="center">You can Directly call on our number</h3>
	   <p align="center">Mobile-07016251211</p>
	   
         <form  action="contactemail.php" method="POST" enctype="multipart/form-data" class="contact">
    <input type="hidden" name="action" value="submit" class="inputtext">
    <h5>Your name:</h5>
    <input name="name" type="text" value="" size="30" class="inputtext"/><br>
    <h5>Your email:</h5>
    <input name="email" type="text" value="" size="30" class="inputtext"/><br>
	<h5>Your Phone:</h5>
    <input name="phone" type="text" value="" size="30" class="inputtext"/><br>
    <h5>Your message:</h5>
    <textarea name="message" rows="7" cols="30" style="background-color:#CCCCCC; width:300px;"></textarea><br>
    <input type="submit" value="Send email" />
    </form>
    
			  </div>
			  <div class="content_image">
			  <img src="image/18.jpg" alt="image1"/>
	        </div>
